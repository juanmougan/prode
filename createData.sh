...
# Create bets
curl -X POST 'localhost:8080/api/bets' -d '{"match":{"id": 7}, "player":{"id": 1}, "result": "HOME", "played": false, "counted": false}' -H "Content-Type: application/json" | jq . ;
curl -X POST 'localhost:8080/api/bets' -d '{"match":{"id": 7}, "player":{"id": 2}, "result": "TIED", "played": false, "counted": false}' -H "Content-Type: application/json" | jq . ;
curl -X POST 'localhost:8080/api/bets' -d '{"match":{"id": 8}, "player":{"id": 1}, "result": "HOME", "played": false, "counted": false}' -H "Content-Type: application/json" | jq . ;
curl -X POST 'localhost:8080/api/bets' -d '{"match":{"id": 8}, "player":{"id": 2}, "result": "HOME", "played": false, "counted": false}' -H "Content-Type: application/json" | jq . ;
